      ...
      <Page size="A4" style={s.page} wrap>
        ...
        <View style={[s.row, s.section]}>
          <View style={s.col}>
            <Text style={s.companyName}>
              {config?.raisonSociale ?? "Sous le Pommier"}
            </Text>
            ...
            {config?.telephone && (
              <Text style={s.small}>Tél. {config.telephone}</Text>
            )}
            {config?.email && <Text style={s.small}>{config.email}</Text>}
            {config?.siret && (
              <Text style={s.small}>SIRET : {config.siret}</Text>
            )}
          ...
          <View style={{ width: 200, alignItems: "flex-end" }}>
            ...
            <View style={{ marginTop: 8 }}>
              ...
              {facture.dateLivraison && (
                <Text style={s.small}>
                  Date prestation : {fmtDate(facture.dateLivraison)}
                </Text>
              )}
        ...
        <View style={s.clientBox}>
          ...
          {facture.client.adresse && (
            <Text style={s.small}>{facture.client.adresse}</Text>
          )}
          ...
          {facture.client.siret && (
            <Text style={s.small}>SIRET : {facture.client.siret}</Text>
          )}
          {facture.client.tvaIntracommunautaire && (
            <Text style={s.small}>
              N° TVA : {facture.client.tvaIntracommunautaire}
            </Text>
          )}
        </View>
        ...
        <View style={s.tableHeader}>
          ...
          <Text style={[s.tableHeaderText, { flex: 1, textAlign: "right" }]}>
            Qté
          </Text>
          <Text style={[s.tableHeaderText, { flex: 1.5, textAlign: "right" }]}>
            PU HT
          </Text>
          <Text style={[s.tableHeaderText, { flex: 1, textAlign: "right" }]}>
            TVA
            ...
            {!franchise && tvaRecap.length > 0 && (
              <>
                ...
                <View style={{ flexDirection: "row", marginBottom: 3 }}>
                  ...
                  <Text style={[s.smallBold, { flex: 1.5, textAlign: "right" }]}>
                    Base HT
                  </Text>
                  <Text style={[s.smallBold, { flex: 1.5, textAlign: "right" }]}>
                    TVA
        ...
        {!isAvoir && (
          <View>
            <Text style={s.legal}>
              ...
              légal majoré de 10 points seront appliquées, ainsi qu'une
              indemnité forfaitaire de recouvrement de 40 € (art. L441-10 C.
              com.).
            </Text>
            <Text style={s.legal}>
