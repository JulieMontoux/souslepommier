    ...
    <div className="mx-auto max-w-3xl px-4 py-12 text-zinc-800">
      ...
      <section className="mb-8 space-y-3">
        ...
        <p className="text-sm leading-relaxed text-zinc-600">
          ...
          question relative à la protection de vos données, contactez notre responsable RGPD via le
          formulaire ci-dessous ou à l&apos;adresse indiquée dans la configuration de
          l&apos;entreprise.
        </p>
      </section>
      ...
      <section className="mb-8 space-y-3">
        ...
        <p className="text-sm text-zinc-500">
          En cas de réponse insatisfaisante, vous pouvez saisir la <strong>CNIL</strong> (Commission
